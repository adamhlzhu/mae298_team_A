...
phase_info = {
    ...
    'desc1': {
        ...
        'user_options': {
            ...
            'distance_bounds': ((0, mission_distance), 'NM'), #3000, 5000
    ...
    'desc2': {
        ...
        'user_options': {
            ...
            'mass_ref': (150_000, 'lbm'),
            'mass_defect_ref': (150_000, 'lbm'),
            'distance_bounds': ((0.0, mission_distance), 'NM'), #5000
            'distance_ref': (mission_distance, 'NM'), #5000
            'distance_defect_ref': (100, 'NM'),
        },
        'initial_guesses': {
            'mass': (136000.0, 'lbm'),

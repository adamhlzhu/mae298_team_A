...
def build_coupled_problem():
    ...
    # Begin:
    N_ENG = 3 # Try 3 or 4 for other BWB configurations, make sure to also change the corresponding values in the CSV file
    ...
    avi_prob.load_inputs("GASP_Geometry_3_engine.csv", phase_info)

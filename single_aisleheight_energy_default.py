...
phase_info = {
    ...
    'climb': {
        ...
        'user_options': {
            ...
            'time_duration_bounds': ((5.0, 90.0), 'min'),
        },
    },
    'cruise': {
        'subsystem_options': {'core_aerodynamics': {'method': 'computed'}},
        'user_options': {
            ...
            'altitude_polynomial_order': 3,
            'throttle_enforcement': 'path_constraint',
            'time_initial_bounds': ((5.0, 90.0), 'min'),
            'time_duration_bounds': ((5.0, 90.0), 'min'),
        },
    },
    'descent': {
        ...
        'user_options': {
            ...
            'altitude_polynomial_order': 3,
            'throttle_enforcement': 'path_constraint',
            'time_initial_bounds': ((5.0, 100.0), 'min'),
            'time_duration_bounds': ((5.0, 120.0), 'min'),
        },
    },
    'post_mission': {
        'include_landing': False,
        'constrain_range': True,
        'target_range': (350.0, 'nmi'),
    },
}

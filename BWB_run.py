...
prob.load_inputs('Aviary/aviary/models/aircraft/blended_wing_body/generic_BWB_GASP.csv', phase_info)
...
prob.model.add_design_var('aircraft:wing:aspect_ratio', lower=7.0, upper=14.0)
prob.model.add_design_var('aircraft:wing:taper_ratio',  lower=0.25, upper=0.45)
prob.model.add_design_var('aircraft:wing:thickness_to_chord_root', lower=0.12, upper=0.20)

...
from BWB_example_two_dof import phase_info
...
# Begin:
N_ENG = 4 # Try 3 or 4 for other BWB configurations, make sure to also change the corresponding values in the CSV file

prop_builder = RegressionPropulsionBuilder(
    coeffs_json_path="Subsystem/Propulsion/engine_regression_coeffs.json",
...
prob.load_inputs(
    'BWB_example_GASP.csv', phase_info
)
